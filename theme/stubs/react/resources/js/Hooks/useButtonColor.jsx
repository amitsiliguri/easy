const useButtonColor = (outlined = false, colorType = "default") => {
  let color = colorType,
    setClasses = "";
  ...
  switch (color) {
    ...
    case "default outlined":
      setClasses =
        "text-gray-800 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800 active:bg-gray-200 dark:active:bg-gray-700 border border-gray-800 dark:border-gray-100";
      break;
    ...
    default:
      setClasses =
        "bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 hover:bg-gray-200 dark:hover:bg-gray-700 active:bg-gray-300 dark:active:bg-gray-600";
      break;
  }
  return setClasses;
};
