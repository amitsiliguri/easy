    ...
    <BreezeAuthenticatedLayout>
        ...
        <form action="#">
            <easy-card seperated>
                ...
                <easy-select :options="input.options" v-model="input.select" id="selectExample" name="selectExample"
                    label="Some Select Label" class="my-4" />

                <easy-input icon="solid-person" placeholder="Some placeholder" id="email" type="email" required
                    autocomplete="username" v-model="input.text" class="my-4" />

                <easy-input icon="solid-person" placeholder="Some number placeholder" id="number" type="number" required
                    v-model="input.number" class="my-4" />
                ...
                <EasyTimePicker v-model="input.time" id="timePickerExample" label="Time picker" error="Invalid time"
                    hint="Time is required" class="my-4" />
